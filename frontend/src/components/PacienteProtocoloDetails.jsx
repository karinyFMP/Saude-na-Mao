...
import './auditor/AuditorProtocoloDetails.css'; // Reutilizando os mesmos estilos visuais
      ...
      <main className="auditor-details-main">
        <div className="auditor-details-header">
          <div className="auditor-details-header-left">
            <button className="auditor-back-btn" onClick={() => navigate('/protocolos')} title="Voltar">
              <ArrowLeft size={18} />
            </button>
                ...
                <div className="auditor-description-box">
                  ...
                  {protocolo.parecer_medico && (
                    <div style={{ paddingTop: '12px', borderTop: '1px dashed #CBD5E1' }}>
                      <strong>Parecer do Médico:</strong> {protocolo.parecer_medico}
                    </div>
                  )}
                </div>
              </div>
